...
machine_info = {
    'METER-1': {
        ...
        'access_token': "MEGde0BiU3OJkpOaM4wc"
    },
    'METER-2': {
        'type_': 'EM',
        'unitId': 2,
        ...
        'access_token': "Uiivj8PeA6khPQ7dAtSZ"
    },
    'METER-3': {
        'type_': 'EM',
        'unitId': 3,
        ...
        'access_token': "y9MwWKUBFkh8D5VwtC1Z"
    },
    'METER-4': {
        'type_': 'EM',
        'unitId': 4,
        ...
        'access_token': "NhfZRdmw6bI2PD28ZgUt"
    },
    'METER-5': {
        'type_': 'EM',
        'unitId': 5,
        ...
        'access_token': "mT7tAlYOqmHHMoC6fuHO"
    },
    'METER-6': {
        'type_': 'EM',
        'unitId': 6,
        ...
        'access_token': "bOsxtbibDith8tq84lWq"
    }}
machine_info_1 = {
    'METER-7': {
        'type_': 'EM',
        ...
        'access_token': "VLW00auGPWDAjecIfY8d"
    },
    'METER-8': {
        'type_': 'EM',
        'unitId': 8,
        ...
        'access_token': "EsPBrNuAM2AHu45aikY8"
    }}
...
def get_ems_values():
    for i in range(2):
        try:
            ...
            mb_client = initiate_client('172.16.29.163')
            ...
            if data0:
                ...
                for group, (j, k) in zip(grouped_values, machine_info.items()):
                    ...
                    log.info(f'gouped values are {group}')
                    log.info(f'reg1 values is {reg1}')
                    reg2 = group[16]  # Replace with your Modbus read function
                    log.info(f'reg2 values is {reg2}')
            ...
            mb_client1 = initiate_client('172.16.29.163')
