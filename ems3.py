...
machine_info = {
    'METER-17': {
        ...
        'access_token': "L7umkLwtou3ZHy4YsWfJ"
    },
    'METER-18': {
        'type_': 'EM',
        'unitId': 10,
        ...
        'access_token': "shrcqcifBco1XoVRWZ2S"
    },
    'METER-19': {
        'type_': 'EM',
        'unitId': 11,
        ...
        'access_token': "jncvSKmK4wxp8vSDQdee"
    },
    'METER-20': {
        'type_': 'EM',
        'unitId': 12,
        ...
        'access_token': "yjHrKZiXywvFuRxGsSYc"
    },
    'METER-21': {
        'type_': 'EM',
        'unitId': 13,
        ...
        'access_token': "uDHCrZXicB07d851Vas9"
    },
    'METER-22': {
        'type_': 'EM',
        'unitId': 14,
        ...
        'access_token': "bh0IXNJq4Nt3OSYRs0K2"
    }}
machine_info_1 = {
    'METER-23': {
        'type_': 'EM',
        ...
        'access_token': "LUG1ZtisC5zU1JAooMyW"
    },
    'METER-24': {
        'type_': 'EM',
        'unitId': 16,
        ...
        'access_token': "U2kG0FG36DHfNbs1Igkh"
    },
    'METER-25': {
        'type_': 'EM',
        'unitId': 16,
        ...
        'access_token': "5YCkSrkbkRQRmwRkabFr"
    }}
...
def post_data(payload, access_token):
    ...
    if send_data:
        try:
            ...
            sync_data = None#c.get_sync_data()
            if sync_data:
                for i in sync_data:
                    if i:
                        ...
                        for sync_payload in payload:
                            ...
                            try:
                                ...
                                log.error(f"[-] Error in sending data {er}")
                    else:
...
def get_ems_values():
    for i in range(2):
        try:
            ...
            mb_client = initiate_client('172.16.29.165')
            ...
            mb_client1 = initiate_client('172.16.29.165')
            data1 = mb_client1.read_holding_registers(120, 60)
            log.info(data1)
